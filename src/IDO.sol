...
/// @notice IDO:用 ETH 预售 OPS token。达到 soft cap 则用户 claim token、owner 提取 ETH；否则用户退款。
/// @dev 参考 https://github.com/lbc-team/hello_foundry/blob/main/src/IDO.sol
contract IDO {
